...
def parse_args():
    ...
    setting = f'seed{args.seed}_Alpha{str(args.alpha)}_surr_{args.dataset}'
    args.savepth = os.path.join('save', 'order_alpha', args.backbone.replace('/', '_'), setting)
...
def main(args):
    ...
    loss_fn = OrderLoss(
        ...
        label_dis='l2', feature_dis='product', label_norm='zscore',
    ...
    if args.mode == 'train':
        ...
        lr_scheduler = PolynomialDecayLR(
            ...
            tot_updates=args.n_epochs * len(train_dataset) // args.batch_size,
